...
export const skillGroups = [
  {
    name: "Frontend",
    slug: "frontend",
    prompt: "import stack from './frontend'",
    focus: "Interfaces that feel fast, accessible, and deliberate",
    skills: [
      { name: "React", role: "core" },
      { name: "Next.js", role: "core" },
      { name: "TypeScript", role: "core" },
      { name: "Tailwind CSS", role: "daily" },
      { name: "Framer Motion", role: "daily" },
      { name: "UI / UX", role: "daily" },
    ],
  },
  {
    name: "Product & Studio",
    slug: "studio",
    prompt: "import craft from './studio'",
    focus: "From design systems to MVPs I ship and maintain",
    skills: [
      { name: "NPUI", role: "core" },
      { name: "Design systems", role: "core" },
      { name: "Open source", role: "core" },
      { name: "Analytics MVPs", role: "daily" },
      { name: "Product scoping", role: "daily" },
      { name: "Component architecture", role: "daily" },
    ],
  },
  {
    name: "Tools & Platform",
    slug: "platform",
    prompt: "import ship from './platform'",
    focus: "The glue that gets work from laptop to production",
    skills: [
      { name: "Git", role: "core" },
      { name: "GitHub Actions", role: "core" },
      { name: "Node.js", role: "daily" },
      { name: "Linux", role: "daily" },
      { name: "Python", role: "daily" },
      { name: "Vercel", role: "daily" },
    ],
  },
] as const;
